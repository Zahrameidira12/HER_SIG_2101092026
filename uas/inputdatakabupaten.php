...
<html>
 ...
 <body>
  ...
  <form action="tambahdatakabupaten.php" method="post">
   <h1>Input Data kabupaten</h1>
   <table cellpadding="5" cellspacing="0" border="0">
    <tbody>

    <tr align="left" valign="top">
      <td align="left" valign="top">kabupaten kode</td>
      <td align="left" valign="top"><input type="text" name="kode" /></td>
     </tr>

     <tr align="left" valign="top">
      <td align="left" valign="top">kabupaten name</td>
      <td align="left" valign="top"><input type="text" name="nama" /></td>
     </tr>

     <tr align="left" valign="top">
      <td align="left" valign="top">geolocation</td>
      <td align="left" valign="top"><input id="lng" type="text" name="geolocation" /></td>
     </tr>

     <tr align="left" valign="top">
      <td align="left" valign="top">Luas</td>
      <td align="left" valign="top"><input id="lng" type="text" name="luas" /></td>
     </tr>
